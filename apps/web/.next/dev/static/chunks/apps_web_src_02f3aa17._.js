...
function LoginPage() {
    ...
    const handleLogin = async (e)=>{
        ...
        setLoading(true);
        try {
            const { signIn } = await __turbopack_context__.A("[project]/node_modules/next-auth/react.js [app-client] (ecmascript, async loader)");
            ...
            if (result?.error) {
                ...
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].success(`로그인 성공`);
                router.push("/");
                router.refresh();
            }
        } catch (error) {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$sonner$2f$dist$2f$index$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["toast"].error("네트워크 오류가 발생했습니다.");
        } finally{
            setLoading(false);
        }
    };
...
//# sourceMappingURL=apps_web_src_02f3aa17._.js.map